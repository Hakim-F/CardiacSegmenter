...
def unet2DvT1(image_file,output_file, checkpoint_path, do_postprocessing=False, use_iter=None):
   ...
   ################## Measure uncertainties based on softmax prediction=logits_out ################
                ...
                if(TotalSize>0):
                   ...
                   MeanT1Slice=np.sum(Nimg[zz]*Myocardium)
                   
                   Certain=CertaintySlice/TotalSize
                   MeanT1=MeanT1Slice/TotalSize
                   print(Certain, MeanT1)
                Uncertainties=[zz/img.shape[2],MeanT1,Certain]
...
if __name__ == '__main__':
    ...
    model_path = os.path.abspath("Models/PostT1/")

    modelSliceSelectionT1_path = os.path.join(model_path, 'PostT1_RF_model.sav')
        ...
        if image_file is not None:
            ...
            if os.path.exists(image_file):
                ...
                if os.path.exists(prediction_file):
                    ...
                    unet2DvT1(image_file,prediction_file, modelSegmentaion_path, do_postprocessing=True,   use_iter=None)
                ...
                if os.path.exists(predictionSelected_file):
                    ...
                    callSelectorRF(image_file,prediction_file,Conf_file,modelSliceSelectionT1_path,predictionSelected_file)